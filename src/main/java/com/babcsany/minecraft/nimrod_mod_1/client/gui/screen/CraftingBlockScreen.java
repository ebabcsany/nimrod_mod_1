package com.babcsany.minecraft.nimrod_mod_1.client.gui.screen;
...
@OnlyIn(Dist.CLIENT)
public class CraftingBlockScreen extends ContainerScreen<CraftingBlockContainer> implements IRecipeShownListener {
   private static final ResourceLocation CRAFTING_TABLE_GUI_TEXTURES = new ResourceLocation(Nimrod_mod_1.MOD_ID,"textures/gui/container/crafting_block_container.png");
   private static final ResourceLocation RECIPE_BUTTON_TEXTURE = new ResourceLocation(Nimrod_mod_1.MOD_ID,"textures/gui/crafting_button.png");
   private final RecipeBookGui recipeBookGui = new RecipeBookGui();
   private boolean widthTooNarrow;

   public CraftingBlockScreen(CraftingBlockContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
