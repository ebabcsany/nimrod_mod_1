...
import com.babcsany.minecraft.nimrod_mod_1.entity.ai.goal.RunDerhhsgxvsAroundLikeCrazyGoal;
...
public abstract class AbstractDerhhsgxvsEntity extends AnimalEntity implements IInventoryChangedListener, IJumpingMount, IEquipable {
   private static final Predicate<LivingEntity> IS_HORSE_BREEDING = (p_213617_0_) -> {
      return p_213617_0_ instanceof AbstractDerhhsgxvsEntity && ((AbstractDerhhsgxvsEntity)p_213617_0_).isBreeding();
   };
   ...
   private static final DataParameter<Byte> STATUS = EntityDataManager.createKey(AbstractDerhhsgxvsEntity.class, DataSerializers.BYTE);
   private static final DataParameter<Optional<UUID>> OWNER_UNIQUE_ID = EntityDataManager.createKey(AbstractDerhhsgxvsEntity.class, DataSerializers.OPTIONAL_UNIQUE_ID);
   ...
   protected AbstractDerhhsgxvsEntity(EntityType<? extends AbstractDerhhsgxvsEntity> type, World worldIn) {
      super(type, worldIn);
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new RunDerhhsgxvsAroundLikeCrazyGoal(this, 1.2D));
      this.goalSelector.addGoal(2, new BreedGoal(this, 1.0D, AbstractDerhhsgxvsEntity.class));
   ...
   public void openGUI(PlayerEntity playerEntity) {
      if (!this.world.isRemote && (!this.isBeingRidden() || this.isPassenger(playerEntity)) && this.isTame()) {
         playerEntity.openDerhhsgxvsInventory(this, this.horseChest);
      }
   ...
   protected void followMother() {
      if (this.isBreeding() && this.isChild() && !this.isEatingHaystack()) {
         LivingEntity livingentity = this.world.getClosestEntityWithinAABB(AbstractDerhhsgxvsEntity.class, MOMMY_TARGETING, this, this.getPosX(), this.getPosY(), this.getPosZ(), this.getBoundingBox().grow(16.0D));
   ...
   protected void setOffspringAttributes(AgeableEntity p_190681_1_, AbstractDerhhsgxvsEntity p_190681_2_) {
   ...
   public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      if (spawnDataIn == null) {
         ...
         ((AgeableData)spawnDataIn).setBabySpawnProbability(0.2F);
      }
