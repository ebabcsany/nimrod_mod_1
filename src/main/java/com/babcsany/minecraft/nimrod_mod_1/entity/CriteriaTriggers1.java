...
import com.babcsany.minecraft.nimrod_mod_1.entity.villager.Snow1GolemTrigger;
...
public class CriteriaTriggers1 {
   ...
   public static final Ieurjjfjuijjfuhujrijfuhfjzufhzuhuhzdjhjuhugugzfgzzzrhdgugugzrz7rzzzezdhzgeugfdjhguezzrghdTrigger IEURJJFJUIJJFUHUJRIJFUHFJZUFHZUHUHZDJHJUHUGUGZFGZZZRHDGUGUGZRZ7RZZZEZDHZGEUGFDJHGUEZZRGHD_TRADE = register(new Ieurjjfjuijjfuhujrijfuhfjzufhzuhuhzdjhjuhugugzfgzzzrhdgugugzrz7rzzzezdhzgeugfdjhguezzrghdTrigger());
   public static final Snow1GolemTrigger SNOW_1_GOLEM_TRIGGER = register(new Snow1GolemTrigger());
   public static final GhzjtvzhzvTradeTrigger GHZJTVZHZV_TRADE_TRIGGER = register(new GhzjtvzhzvTradeTrigger());
