...
import com.babcsany.minecraft.nimrod_mod_1.entity.villager.Ieurjjfjuijjfuhujrijfuhfjzufhzuhuhzdjhjuhugugzfgzzzrhdgugugzrz7rzzzezdhzgeugfdjhguezzrghdTrades;
import com.babcsany.minecraft.nimrod_mod_1.entity.villager.Snow1GolemTrades;
...
public abstract class AbstractSnow1GolemEntity extends AgeableEntity implements INPC, IMerchant {
   private static final DataParameter<Integer> SHAKE_HEAD_TICKS = EntityDataManager.createKey(AbstractSnow1GolemEntity.class, DataSerializers.VARINT);
   ...
   public AbstractSnow1GolemEntity(EntityType<? extends AbstractSnow1GolemEntity> type, World worldIn) {
      super(type, worldIn);
   ...
   public void onTrade(MerchantOffer offer) {
      ...
      if (this.customer instanceof ServerPlayerEntity) {
         CriteriaTriggers1.SNOW_1_GOLEM_TRIGGER.test((ServerPlayerEntity)this.customer, this, offer.getSellingStack());
      }
    ...
    */
   protected void addTrades(MerchantOffers givenMerchantOffers, Snow1GolemTrades.ITrade[] newTrades, int maxNumbers) {
      ...
      for(Integer integer : set) {
         Snow1GolemTrades.ITrade villagertrades$itrade = newTrades[integer];
