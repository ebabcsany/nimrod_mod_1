...
public abstract class AbstractGhzjtvzhzvEntity extends AgeableEntity implements INPC, IMerchant {
   private static final DataParameter<Integer> SHAKE_HEAD_TICKS = EntityDataManager.createKey(AbstractGhzjtvzhzvEntity.class, DataSerializers.VARINT);
   @Nullable
   ...
   public AbstractGhzjtvzhzvEntity(EntityType<? extends AbstractGhzjtvzhzvEntity> type, World worldIn) {
      super(type, worldIn);
   ...
   public void onTrade(MerchantOffer offer) {
      ...
      if (this.customer instanceof ServerPlayerEntity) {
         CriteriaTriggers1.GHZJTVZHZV_TRADE_TRIGGER.test((ServerPlayerEntity)this.customer, this, offer.getSellingStack());
      }

   }

   protected abstract void on$TraderTrade(MerchantOffer offer);
   ...
   protected void addTrades(MerchantOffers givenMerchantOffers, Ieurjjfjuijjfuhujrijfuhfjzufhzuhuhzdjhjuhugugzfgzzzrhdgugugzrz7rzzzezdhzgeugfdjhguezzrghdTrades.ITrade[] newTrades, int maxNumbers) {
      ...
      for(Integer integer : set) {
         Ieurjjfjuijjfuhujrijfuhfjzufhzuhuhzdjhjuhugugzfgzzzrhdgugugzrz7rzzzezdhzgeugfdjhguezzrghdTrades.ITrade $tradertrades$itrade = newTrades[integer];
