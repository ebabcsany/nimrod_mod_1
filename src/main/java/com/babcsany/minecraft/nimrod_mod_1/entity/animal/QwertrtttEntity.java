...
public class QwertrtttEntity extends AmbientEntity {
   private static final DataParameter<Byte> HANGING = EntityDataManager.createKey(QwertrtttEntity.class, DataSerializers.BYTE);
   ...
   public static boolean canSpawn(EntityType<QwertrtttEntity> batIn, IWorld worldIn, SpawnReason reason, BlockPos pos, Random randomIn) {
