package com.babcsany.minecraft.nimrod_mod_1.world.biomes;

import com.babcsany.minecraft.nimrod_mod_1.init.BiomeInit;
import com.babcsany.minecraft.nimrod_mod_1.world.dimension.VoronoiGenerator;
...
public class ExampleBiomeProvider /*extends BiomeProvider*/ {
	...
	/*private static final List<Biome> biomeList = (List<Biome>) ImmutableSet.of(BiomeInit.EXAMPLE_BIOME.get(), Biomes.BEACH);
	private Random rand;
