...
public class EffectInstance implements Comparable<EffectInstance>, net.minecraftforge.common.extensions.IForgeEffectInstance {
   ...
   public EffectInstance(Effect potionIn, int durationIn, int amplifierIn, boolean ambientIn, boolean showParticlesIn, boolean showIconIn, @Nullable EffectInstance hiddenEffectsIn) {
      this.potion = potionIn;
      this.duration = durationIn;
      this.amplifier = amplifierIn;
      this.ambient = ambientIn;
      this.showParticles = showParticlesIn;
      this.showIcon = showIconIn;
      this.hiddenEffects = hiddenEffectsIn;
   }
   ...
   private static EffectInstance readInternal(Effect effect, CompoundNBT nbt) {
      ...
      return readCurativeItems(new EffectInstance(effect, j, i < 0 ? 0 : i, flag, flag1, flag2, effectinstance), nbt);
   }
