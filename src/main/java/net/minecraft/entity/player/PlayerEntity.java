...
public abstract class PlayerEntity extends LivingEntity {
   ...
   private final Collection<IFormattableTextComponent> prefixes = new java.util.LinkedList<>();
   private final Collection<IFormattableTextComponent> suffixes = new java.util.LinkedList<>();
   ...
   public void openDerhhsgxvsInventory(AbstractDerhhsgxvsEntity horse, IInventory inventoryIn) {
   }
