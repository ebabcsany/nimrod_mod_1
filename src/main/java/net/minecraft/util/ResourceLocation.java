...
public class ResourceLocation implements Comparable<ResourceLocation> {
   ...
   protected ResourceLocation(String[] resourceParts) {
      ...
      if (!isValidNamespace(this.namespace)) {
         throw new ResourceLocationException("Non [a-zA-Z0-9_.-] character in namespace of location: " + this.namespace + ':' + this.path);
      } else if (!isPathValid(this.path)) {
         throw new ResourceLocationException("Non [a-zA-Z0-9/._-] character in path of location: " + this.namespace + ':' + this.path);
      }
   }
